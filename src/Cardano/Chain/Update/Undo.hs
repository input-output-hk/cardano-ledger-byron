...
-- | State of Proposal which can't be classified as approved or
-- rejected.
...
-- | State of Proposal which can be classified as approved or
-- rejected.
