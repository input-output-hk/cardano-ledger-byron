...
\newcommand{\delegaator}[2]{\fun{\delegatorname} ~ #1 ~ #2}

\newcommand{\delmap}{\delta}
\newcommand{\signmap}{\xi}
...
A new block $b$ with an index $bIx \in BlockIx$, signed by a signing key
...
This is encoded by an inference rule given in \eqref{}.
