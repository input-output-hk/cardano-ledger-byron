...
\newcommand{\DelegState}{\type{DelegState}}
...
block (neither directly or indirectly via delegation), the last added block is
the genesis block $p = g_0$ and no delegation happened, as given in
Figure~\ref{fig:init-bc-state}.
