...
\begin{figure}
  \begin{equation}\label{eq:delegation-change}
    \inference
    {\var{vk_s} \mapsto s_p \Rightarrow s_p < s
    }
    {
      \left(
      \begin{array}{r}
  ...
  \end{equation}
  \nextdef
  \begin{equation}\label{eq:delegation-nop}
    \inference
    {\var{kv_s} \mapsto s_p \wedge s \leq s_p
    }
    {
      \left(
      \begin{array}{r}
...
\subsubsection{Delegation sequences}
